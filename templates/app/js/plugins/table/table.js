	...
	self.plugin.table = {
		...
		prop : function(isInsert) {
			var html = [
				...
				'<input style="display: none;" type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" />',
				'<select name="widthType" style="display: none;">',
