...
/*
	...
	$RCSfile: html.func.php,v $
	$Revision: 1.40 $
	$Date: 2007/04/10 19:47:33 $
*/
...
function label($showarr) {
	...
	switch ($showarr['type']) {
		...
		case 'upload':
			...
			<div id="uploadbox">
			<div class="tabs">
			<a id="localuploadtab" href="javascript:;" onclick="hideshowtags(\'uploadbox\', \'localupload\');" class="current">'.$alang['html_func_thumb_local'].'</a>
			<a id="remoteuploadtab" href="javascript:;" onclick="hideshowtags(\'uploadbox\', \'remoteupload\');">'.$alang['html_func_thumb_remote'].'</a>';
			...
			$thetext .= '</div>
				<div id="localupload">
					<table cellpadding="0" cellspacing="0">
						<tr>
							...
							<td rowspan="3" class="upbtntd"><button onclick="return uploadFile(0)">'.$alang['html_func_thumb_upload'].'</button></td>
						</tr>
						<tr>
				...
				<div id="remoteupload" style="display: none;">
					<table cellpadding="0" cellspacing="0">
						<tr>
							...
							<td rowspan="2" class="upbtntd"><button onclick="return uploadFile(1)" />'.$alang['html_func_thumb_upload'].'</button></td>
						</tr>
						<tr>
							<th>'.$alang['html_func_thumb_explain'].':</th>
				...
				<div id="batchupload" style="display: none;">
					<table summary="" cellpadding="0" cellspacing="6" border="0" width="100%">
						<tr>
							<td><span id="batchdisplay"><input class="fileinput" id="batch_1" name="batchfile[]" onchange="insertimg(this)" type="file" /></span></td>
