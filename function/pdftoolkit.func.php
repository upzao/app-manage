...
/*
	...
	$RCSfile: pdftoolkit.func.php,v $
	$Revision: 1.1 $
	$Date: 2006/10/26 05:13:25 $
*/
...
/**
 *@return returns an associative array (keys: R,G,B) from html code (e.g. #3FE5AA)
 */
function ConvertColor($color="#000000") {
	...
	if(($color{0} != '#') && ( strstr($color,'(') === false )) $color = $common_colors[strtolower($color)];
	if ($color{0} == '#') {
